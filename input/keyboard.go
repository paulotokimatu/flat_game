...
type KeyCallback func(key Key, event KeyEvent)

const (
	EventKeyPressed  KeyEvent = 0
	EventKeyReleased KeyEvent = 1
	KeyUnknown       Key      = -1
	KeySpace         Key      = 32
...
type IKeyEventListener interface {
	OnKeyEvent(key Key, event KeyEvent)
}
